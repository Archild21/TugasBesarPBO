...
//        }
    ...
    private void initComponents() {
        ...
        add(notif, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 250, 220, 120));
        ...
        add(settingsLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 30, -1, -1));

        supermarketLabel.setFont(new java.awt.Font("Poppins Medium", 0, 15)); // NOI18N
        supermarketLabel.setText("Supermarket ");
        add(supermarketLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, -1, -1));

        labelNamaBarang.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        labelNamaBarang.setText("Nama supermarket");
        add(labelNamaBarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, -1, -1));
        ...
        add(inputNamaSupermarket, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 170, -1, -1));

        labelNamaBarang2.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        labelNamaBarang2.setText("Old password");
        add(labelNamaBarang2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 210, -1, -1));
        ...
        add(inputOldPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 240, -1, -1));
        ...
        add(inputNewPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 320, -1, -1));

        labelNamaBarang3.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        labelNamaBarang3.setText("New password");
        add(labelNamaBarang3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 290, -1, -1));
        ...
        add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 380, -1, 34));
        ...
        add(btnMakeCashAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 670, 165, 34));

        changePassLabel1.setFont(new java.awt.Font("Poppins Medium", 0, 15)); // NOI18N
        changePassLabel1.setText("Cashier Account");
        add(changePassLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 460, -1, -1));

        labelNamaBarang4.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        labelNamaBarang4.setText("Username");
        add(labelNamaBarang4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 500, -1, -1));
        ...
        add(inputCashierUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 530, -1, -1));
        ...
        add(inputCashierPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 610, -1, -1));

        labelNamaBarang5.setFont(new java.awt.Font("Poppins", 0, 15)); // NOI18N
        labelNamaBarang5.setText("Password");
        add(labelNamaBarang5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 580, -1, -1));
        ...
        add(usernameAlert, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 560, -1, -1));
        ...
        add(passwordAlert, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 640, -1, -1));
        ...
        add(updateBtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 670, 89, 34));
